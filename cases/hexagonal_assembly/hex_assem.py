...
mc_params = MontecarloParams(2000, 500, 50, seed=1474468046) 
libraries = SerpentLibraries(acelib='"jeff311/sss_jeff311u.xsdata"')
ene_structure = [0, 1.00E-10, 7.49E-04, 1.50E-02, 4.09E-02, 1.11E-01, 3.02E-01, 8.21E-01, 2.23E+00, 2.0E+01]
...
# Defining pins  -------------------------------------------------------
p_i = Pin("pin_inner")
mat_lev = [helium_gas, inner_fuel, helium_gas, cladding, na_coolant]
