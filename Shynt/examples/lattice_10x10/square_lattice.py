...
import Shynt
from Shynt.api_py.Mesh.make_mesh import make_mesh
...
mc_params = Shynt.montecarlo.MontecarloParams(3_000, 1_500, 500)
...
fuel2 = Shynt.materials.Material("fuel2", mass_density=10.424, color=(200,200,150))
...
fuel3 = Shynt.materials.Material("fuel3", mass_density=10.424, color=(200,150,150))
...
fuel4 = Shynt.materials.Material("fuel4", mass_density=10.424, color=(200,150,250))
...
fuel5 = Shynt.materials.Material("fuel5", mass_density=10.424, color=(200,250,250))
...
fuel6 = Shynt.materials.Material("fuel6", mass_density=10.424, color=(100,10,250))
...
# plot_cell(model_cell, dimensions=(5000,5000), name="lattice")
