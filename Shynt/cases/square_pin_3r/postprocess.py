...
shynt_output_file = dir_base + "output_RMM/_rmm_flux.csv"
...
# Serpent flux  --------------------------------------------------------------------
detector_out_file = dir_base + "reference/reference_pin3r.serp_det0.m"
...
for c_id in coarse_nodes_diagonal_hybrid:
  ...
  regions_to_plot.append(regions_mat_rel["clading"])
  regions_to_plot.append(regions_mat_rel["fuel1"])
  regions_to_plot.append(regions_mat_rel["clading"])
  regions_to_plot.append(regions_mat_rel["coolant"])
...
for g in range(energy_g):
  plt.figure()
  plt.errorbar(
    [0,1,2,3,4], serpent_arrays_to_plot[g], 
