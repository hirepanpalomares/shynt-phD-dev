...
mc_params = Shynt.montecarlo.MontecarloParams(1_000, 1500, 500)
...
coolant2 = Shynt.materials.Material("coolant2", moder="lwtr 1001", mass_density=0.443760, color=(150,150,200))
coolant2.addIsotope(oxygen06, atom_fraction=0.33333)
coolant2.addIsotope(hydrogen, atom_fraction=0.66667)
...
mat_lev = [fuel1, coolant, coolant]
rad_lev = [0.4335, 0.5300, None]
...
local_mesh_type = {
    "pie": ["fuel1", "coolant2", "coolant"]
}
# still a cell
meshed_model_cell = make_mesh(model_cell, global_mesh_type="pin_cell", local_mesh_type=local_mesh_type)
...
Shynt.run(model_universe, serp_dir="serpent_files")
