...
global_cell_type = {
    "type_": "square_mesh",
    "y_div": [
        8.509479, 7.6585311, 6.8075832, 5.9566353, 5.1056874, 4.2547395, 3.4037916, 
        2.5528437, 1.7018958, 0.8509479, 0.0, -0.8509479, -1.7018958, -2.5528437, 
        -3.4037916, -4.2547395, -5.1056874, -5.9566353, -6.8075832, -7.6585311, -8.509479
    ],
    "x_div": []
}
assembly_cell_meshed = make_mesh(
    assembly_cell, global_mesh_type="square_mesh_pin", local_mesh_type=local_mesh_type
)
# raise SystemExit
# Total Universe (root)
