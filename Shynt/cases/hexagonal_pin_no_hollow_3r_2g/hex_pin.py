...
mc_params = MontecarloParams(50000, 3000, 1000) 
libraries = SerpentLibraries(acelib='"jeff311/sss_jeff311u.xsdata"')

ene_structure = [1.00E-10, 1E-02, 2.00E+01]
...
# Main problem cell
assembly_cell = Cell("hex_assembly_problem", region=-hex_wrap, fill=p_i)
...
# plot_cell(assembly_cell, dimensions=(3000,3000), name="hex_pin_cladding")
