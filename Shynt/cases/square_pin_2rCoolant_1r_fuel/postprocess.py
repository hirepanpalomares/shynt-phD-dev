...
from pin import model_universe, model_cell, energy_grid
...
dir_base = "/home/hirepan/Documents/chalmers/Project/codes/Shynt/repo/Shynt/cases/square_pin_2rCoolant_1r_fuel/"
# SHYNT fluxes -------------------------------------------------------------------

shynt_output_file = dir_base + "output_RMM_test_less_det_v2/test_less_det_v2_rmm_flux.csv"
...
# Serpent flux  --------------------------------------------------------------------
detector_out_file = dir_base + "reference/50_000-1500-500/reference_pin2rCool1rFuel.serp_det0.m"
...
flux = {"fuel": serp_fuel_flux["1"], "cool1": serp_cool1_flux["2"], "cool2": serp_cool2_flux["3"]}
sigma = {"fuel": serp_errors_fuel["1"], "cool1": serp_errors_cool1["2"], "cool2": serp_errors_cool2["3"]}
...
for g in range(energy_g):
  plt.figure()
  plt.errorbar(
    [0,1,2,3,4], serpent_arrays_to_plot[energy_g-1-g], 
    yerr=np.array(serpent_arrays_to_plot[energy_g-1-g])*np.array(serpent_sigma_to_plot[energy_g-1-g]), 
    label="Serpent"
  )
  print(serpent_arrays_to_plot[energy_g-1-g])
  print(serpent_sigma_to_plot[energy_g-1-g])
  print(np.array(serpent_arrays_to_plot[energy_g-1-g])*np.array(serpent_sigma_to_plot[energy_g-1-g]))
  plt.plot(shynt_arrays_to_plot[g], label="SHYNT")
  # plt.ylim([0.02, 0.17])
