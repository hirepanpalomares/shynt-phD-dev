...
mc_params = MontecarloParams(10_000, 3000, 1500) 
...
# Assembly definition --------------------------------------------------
hex_wrap = InfiniteHexagonalCylinderXtype(0, 0, 0.491295, boundary="reflective")

print(hex_wrap.volume)
print(hex_wrap.volume/4 - 0.10009821052684138)

# Main problem cell
assembly_cell = Cell("hex_pin_problem", region=-hex_wrap, fill=p_i)
outside_cell = Cell("outside_world", region=+hex_wrap)

assembly_cell_meshed = make_mesh(
    assembly_cell, global_mesh_type="square_mesh_pin", local_mesh_type="cell"
)
...
# plot_cell(assembly_cell, dimensions=(500,500), name="hex_pin")