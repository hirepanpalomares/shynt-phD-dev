...
plot_cell(
  ...
  name=f"hex_lattice_noHollow_g{g_plot}_serp_uncert",
  cell_colors=uncert_colors[g_plot]
)
...
cb = mpl.colorbar.ColorbarBase(
  ax, 
  cmap=cmap_uncert,   
  norm=normalize_uncert,
  spacing='uniform',
  orientation='horizontal',
  extend='neither',
)
mpl.pyplot.savefig(f"hex_lattice_noHollow_g{g_plot}_serp_COLORMAP_uncert.png")
