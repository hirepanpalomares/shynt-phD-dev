...
from Shynt.cases.hexagonal_pin_no_hollow_3r_8g.hex_pin import assembly_cell
from Shynt.cases.hexagonal_pin_no_hollow_3r_8g.hex_pin import root_universe
from Shynt.cases.hexagonal_pin_no_hollow_3r_8g.hex_pin import energy_grid
...
# Serpent flux  --------------------------------------------------------------------
detector_out_file = "/home/hirepan/Documents/chalmers/Project/codes/Shynt/repo/Shynt/cases/"
detector_out_file += "hexagonal_pin_no_hollow_3r_8g/reference/reference_calc_3r_8g.serp_det0.m"
...
serp_Na_flux, serp_errors_Na = postprocess.get_flux_from_detector_file(detector_out_file, "3")

flux = {"fuel": serp_fuel_flux["1"], "clad": serp_clad_flux["2"], "cool": serp_Na_flux["3"]}
sigma = {"fuel": serp_errors_fuel["1"], "clad": serp_errors_clad["2"], "cool": serp_errors_Na["3"]}
...
for g in range(energy_g):
  ...
  plt.savefig(f"/home/hirepan/Documents/chalmers/Project/codes/Shynt/repo/Shynt/cases/hexagonal_pin_no_hollow_3r_8g/g{g}_diagonal_serp")
...
for g in range(energy_g):
  ...
  plt.savefig(f"/home/hirepan/Documents/chalmers/Project/codes/Shynt/repo/Shynt/cases/hexagonal_pin_no_hollow_3r_8g/g{energy_g-1-g}_diagonal_SHYNT")
...
for g in range(energy_g):
  ...
  # plt.ylim([0.02, 0.17])
  plt.legend()
  plt.savefig(f"/home/hirepan/Documents/chalmers/Project/codes/Shynt/repo/Shynt/cases/hexagonal_pin_no_hollow_3r_8g/g{g}_SHYNTvsSerpent")
