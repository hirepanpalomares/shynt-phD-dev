...
mc_params = MontecarloParams(300_000, 1500, 250) 
...
# Main problem cell
model_cell = Cell("hex_assembly_problem", region=-hex_wrap, fill=p_i)
outside_cell = Cell("outside_world", region=+hex_wrap)
assembly_cell_meshed = make_mesh(
    model_cell, global_mesh_type="pin_cell", local_mesh_type="material"
)
