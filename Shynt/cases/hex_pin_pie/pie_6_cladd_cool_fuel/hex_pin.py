...
mc_params = MontecarloParams(10_000, 3000, 1000) 
...
# Defining pins  -------------------------------------------------------
p_i = Pin("pin_inner")
mat_lev = [inner_fuel, cladding, na_coolant]
rad_lev = [0.36947, 0.43035, None]
...
local_mesh_type = {
    "pie": ["inner_fuel", "cladding", "na_coolant"],
    "slices": [(30,90),(90,150),(150,210),(210,270),(270,330),(330,30)]
...
Shynt.run(root_universe, serp_dir='serp_files_10_000', name_out='10_000')
