...
from Shynt.api_py.Mesh.coarse_node import CoarseNode, HexAssemCoarseNode
    ...
    if isinstance(universe, SquareLattice):
      for y in range(universe.ny):
        ...
        for x in range(universe.nx):
          ...
          self.coarse_nodes[node_counter] = coarse_node
          node_counter += 1
