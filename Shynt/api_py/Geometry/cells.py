...
class Cell:
  ...
  """A class that defines a cell in the geometry. A cell can
  be filled with a material or a universe and is delimited
  by a region defined as a halfspace plane.
  ...
  __content : Material | Universe

  __universe : list
    Array of strings, every element of the array is the name
    of a Universe where the cell belongs to.
  __isClone : bool
  ...
  calculate_surface_area_relation():
  ...
  serpent_syntax_cell_with_material_gcu(simple_cell)

  serpent_syntax_gcu

  serpent_syntax

  serpent_syntax_pin_cell_inside
  ...
  def check_fill(self, fill):
    from .universes import (
      HexagonalLatticeTypeX, Pin, SquareLattice, Universe
    )
    from .universes import (
      Root, Lattice
    )
  ...
  def scale(self, scale_f):
    ...
    #   print(self)
    #   print(self.content)
    #   print(self.content.cells[5])
    #   print(self.content.cells[5].content)
    #   print(self.content.cells[5].content.cells[4])
    #   print(self.content.cells[5].content.cells[4].content)
